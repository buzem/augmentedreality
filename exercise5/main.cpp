...
// Added in sheet 5 - Start *****************************************************************
#include <iomanip>
// Added in sheet 5 - End *****************************************************************
        ...
        for (const auto &contour : contours) {
            ...
            for (int i = 0; i < n_points; ++i) {
                ...
                for (int j = 1; j < 7; ++j) {
                    ...
                    vector<double> sobelValues(static_cast<unsigned long>(strip.stripeLength - 2));
            ...
            // Added in sheet 5 Ex10- Start *****************************************************************
            int angle = 0;
            // Added in sheet 5 Ex10- End *******************************************************************
            for (int i = 1; i < 4; ++i) {
            ...
            for (auto &corner : corners) {
                corner.x -= 160; //here you have to use your own camera resolution (x) * 0.5
                corner.y = -corner.y + 120; //here you have to use your own camera resolution Ja * 0.5
            }

            float resultMatrix[16];
            estimateSquarePose(resultMatrix, (Point2f *) corners, 0.045);
